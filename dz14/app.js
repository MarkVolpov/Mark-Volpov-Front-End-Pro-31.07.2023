...
let person = new Student("John", "Doe", 1988, [100,100,60,60,100,70,80,90,90,90])
let person2 = new Student("Alex", "Blue", 1999, [90,95,100,75,87,90,100])
let person3 = new Student("Andrew", "White", 1999, [100,100,100,55,89,89,100])

console.log(person.absent(),person.absent(),person.absent(),person.absent(),person.visit,person.summary())
console.log(person2.present(),person2.absent(),person2.absent(),person2.present(),person2.visit,person2.summary())
console.log(person3.absent(),person3.present(),person3.present(),person3.absent(),person3.visit,person3.summary())
